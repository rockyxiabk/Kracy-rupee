...
import com.great.cash.rupee.module.user.feedback.listener.OnItemLongClickListener;
...
public class GridImageAdapter extends
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.gv_filter_image_fish,
                viewGroup, false);
    ...
    //移除图片监听
    private OnRemoveIndexListener onRemoveIndexListener;
    public void setListener(OnRemoveIndexListener onRemoveIndexListener) {
        this.onRemoveIndexListener = onRemoveIndexListener;
    }

    interface OnRemoveIndexListener {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            viewHolder.mIvDel.setOnClickListener(view -> {
                ...
                if (index != RecyclerView.NO_POSITION && list.size() > index) {
                    ...
                    onRemoveIndexListener.remove(index);
                }
            });
