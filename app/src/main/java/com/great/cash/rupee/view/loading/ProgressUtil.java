...
public class ProgressUtil {
     ...
     */
    public static ProgressUtil create(Context context) {
     ...
     * @return An unique HUD instance
     */
    public static ProgressUtil create(Context context, Style style) {
        return new ProgressUtil(context).setStyle(style);
    }
     ...
     * @return Current HUD
     */
    public ProgressUtil setStyle(Style style) {
        View view = null;
        switch (style) {
     ...
     * @return Current HUD
     */
    public ProgressUtil setDimAmount(float dimAmount) {
     ...
     * @return Current HUD
     */
    public ProgressUtil setSize(int width, int height) {
     ...
     */
    @Deprecated
    public ProgressUtil setWindowColor(int color) {
        mWindowColor = color;
        return this;
    }

    public ProgressUtil setOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
     ...
     * @return Current HUD
     */
    public ProgressUtil setBackgroundColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public ProgressUtil setCornerRadius(float radius) {
     ...
     * @return Current HUD
     */
    public ProgressUtil setAnimationSpeed(int scale) {
        mAnimateSpeed = scale;
        return this;
    }
     ...
     * @return Current HUD
     */
    public ProgressUtil setLabel(String label) {
     ...
     * @return Current HUD
     */
    public ProgressUtil setLabel(String label, int color) {
     ...
     * @return Current HUD
     */
    public ProgressUtil setDetailsLabel(String detailsLabel) {
     ...
     * @return Current HUD
     */
    public ProgressUtil setDetailsLabel(String detailsLabel, int color) {
     ...
     * @return Current HUD
     */
    public ProgressUtil setMaxProgress(int maxProgress) {
     ...
     * @return Current HUD
     */
    public ProgressUtil setCustomView(View view) {
        if (view != null) {
            mProgressDialog.setView(view);
        } else {
     ...
     * @return Current HUD
     */
    public ProgressUtil setCancellable(boolean isCancellable) {
     ...
     * @return Current HUD
     */
    public ProgressUtil setCancellable(DialogInterface.OnCancelListener listener) {
     ...
     * @return Current HUD
     */
    public ProgressUtil setAutoDismiss(boolean isAutoDismiss) {
     ...
     * @return Current HUD
     */
    public ProgressUtil setGraceTime(int graceTimeMs) {
        mGraceTimeMs = graceTimeMs;
        return this;
    }

    public ProgressUtil show() {
        if (!isShowing()) {
            mFinished = false;
            if (mGraceTimeMs == 0) {
    ...
    private class ProgressDialog extends Dialog {
        ...
        private void addViewToFrame(View view) {
            if (view == null) return;
            int wrapParam = Helper.dpToPixel(40, context);
