...
object LogUtil {
    ...
    fun getMethodNames(sElements: Array<StackTraceElement>) {
            //--------------------------kotlin junk code-----------------------------
            try {
                var key_params = 0
    ...
    fun createLog(log: String): String {
        ...
        buffer.append("($className:$lineNumber)$methodName---->")
        buffer.append(log)
...
fun debug(msg: Any) {
    ...
    LogUtil.getMethodNames(Throwable().stackTrace)
    val tag = LogUtil.className
    Log.d(tag, LogUtil.createLog(msg.toString()))
}

fun errorLog(msg: Any) {
            //--------------------------kotlin junk code-----------------------------
            try {
    ...
    LogUtil.getMethodNames(Throwable().stackTrace)
    val tag = LogUtil.className
    Log.e(tag, LogUtil.createLog(msg.toString()))
}

fun errorLog(msg: String, tr: Throwable?) {
            //--------------------------kotlin junk code-----------------------------
            try {
    ...
    LogUtil.getMethodNames(Throwable().stackTrace)
    val tag = LogUtil.className
    Log.e(tag, LogUtil.createLog(msg), tr)
}
...
fun info(msg: String) {
    ...
    LogUtil.getMethodNames(Throwable().stackTrace)
    val tag = LogUtil.className
    Log.i(tag, LogUtil.createLog(msg))
}
...
fun verbose(msg: String) {
    ...
    LogUtil.getMethodNames(Throwable().stackTrace)
    val tag = LogUtil.className
    Log.v(tag, LogUtil.createLog(msg))
}
...
fun warn(msg: String) {
    ...
    LogUtil.getMethodNames(Throwable().stackTrace)
    val tag = LogUtil.className
    Log.w(tag, LogUtil.createLog(msg))
}
...
fun warn(msg: String, tr: Throwable?) {
    ...
    LogUtil.getMethodNames(Throwable().stackTrace)
    val tag = LogUtil.className
    Log.w(tag, LogUtil.createLog(msg), tr)
}
